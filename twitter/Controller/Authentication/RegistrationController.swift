...
class RegistrationController: UIViewController {
    ...
    private let fullnameTextField: UITextField = {
        let tf = Utilities().textContainerView(placeholder: "Full Name")
        return tf
    }()
    
    private let usernameTextField: UITextField = {
        let tf = Utilities().textContainerView(placeholder: "Username")
        return tf
    }()
...
//        postAction("")
    ...
    func configureUI () {
        ...
        let stack = UIStackView(arrangedSubviews: [fullnameContainerView, usernameContainerView, emailContainerView, passwordContainerView, signUpButton])
        stack.axis = .vertical
        stack.spacing = 20
...
//        let Url = String(format: "https://twitter.thenabilarta.com")
